...
IsArray(
	...
	errorMessage, stopLoop = IsArray(
		arraytype.String,
		Array{
			AllowEmptyErrorMessage: customErrorMessage,
		},
		[]Validator{},
	)([]string{})
...
IsArray(
	...
	errorMessage, stopLoop = IsArray(
		...
		Array{
			MaxLength:             3,
			MaxLengthErrorMessage: customErrorMessage,
		},
		[]Validator{},
	)([]string{"a", "b", "c", "d"})
...
IsArray(
	...
	Array{
		MaxLength: 3,
		MaxLengthErrorMessage: "error",
	},
	[]Validator{},
)([]string{"a", "b", "c", "d"}) = %v, %t; expected: "error", true
		`,
			getArgs()...,
		)
	}
